...
echo __( '<ol><li>Place new theme directories inside <strong>prosperent-themes</strong>.<a href="#" class="prosper_tooltip"><span style="max-width:465px;">New theme directories should contain one or all of the following: <br>&bull;&nbsp;<strong>insertProd.php</strong> - this is for the Inserter<br>&bull;&nbsp;a <strong>CSS file</strong> - contains the CSS for insertProd.php<br>(The CSS file can be named anything, the plugin is looking for the extension .css).</span></a></li><li>Select the desired theme.</li></ol>', 'prosperent-suite' );
