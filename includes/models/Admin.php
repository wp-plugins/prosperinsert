 ...
 * @package Model
 */
class Model_Insert_Admin extends Model_Insert_Base
{
	/**
	 ...
	 */
	public $adminPages = array('prosper_general', 'prosper_autoComparer', 'prosper_advanced', 'prosper_themes');
	...
	{
		wp_register_style( 'prospere_admin_style', PROSPERINSERT_URL . 'includes/css/admin.min.css', array(), $this->getVersion() );
	...
	public function addActionLink( $links, $file ) 
	{
		...
		if ( $file == $this_plugin ) 
		{
			$settings_link = '<a href="' . admin_url( 'admin.php?page=prosperinsert_general' ) . '">' . __( 'Settings', 'prosperent_suite' ) . '</a>';
	...
	public function adminHeader( $title, $form = true, $option = 'prosperent_options', $optionshort = 'prosperSuite', $contains_files = false ) 
	{
		...
		?>
		<img src="<?php echo PROSPERINSERT_IMG . '/Gears-32.png'; ?>"/><?php echo '<h1 style="margin-left:8px;display:inline-block;font-size:34px;">ProsperInsert</h1>';?>
